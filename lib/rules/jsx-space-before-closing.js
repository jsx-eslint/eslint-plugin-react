  ...
  create(context) {
    ...
    return {
      JSXOpeningElement(node) {
        ...
        if (configuration === 'always' && !isSpaceBetweenTokens(context, leftToken, closingSlash)) {
        ...
        } else if (configuration === 'never' && isSpaceBetweenTokens(context, leftToken, closingSlash)) {
