    ...
    return {
      ...
      MemberExpression: function(node) {
        ...
        if (utils.isES6Component(component)) {
          ...
          // TODO: Check if property is being accessed from a rest object
        }
      },
      ...
      VariableDeclarator: function(node) {
        ...
        if (!isDestructuring || !isDestructuring) {
          return;
        }
        ...
        if (utils.isES5Component(component) || utils.isES6Component(component)) {
          ...
          if (!isDestructuringClassProperties || !isInRenderMethod(node)) {
            return;
          }
        ...
        // TODO: Add checks here for destrucuting props inside functional component
      }
    };
  })
};
