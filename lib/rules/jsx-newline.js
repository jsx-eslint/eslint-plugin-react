...
module.exports = {
  ...
  create(context) {
    ...
    const removeNewLines = configuration.removeNewLines;
    console.log(removeNewLines);
        ...
        jsxElementParents.forEach((parent) => {
          parent.children.forEach((element, index, elements) => {
            if (element.type === 'JSXElement' || element.type === 'JSXExpressionContainer') {
              ...
              console.log('firstAdjacentSibling', firstAdjacentSibling);
              console.log('secondadjacentSibling', secondAdjacentSibling);
              if (
