  ...
  create(context) {
    ...
    */
    ...
    function validateBraceSpacing(node) {
      ...
      if (spacing === SPACING.always) {
        if (!isSpaceBetweenTokens(context, first, second)) {
          reportRequiredBeginningSpace(node, first);
        } else if (!config.allowMultiline && isMultiline(first, second)) {
          reportNoBeginningNewline(node, first, spacing);
        }
        if (!isSpaceBetweenTokens(context, penultimate, last)) {
        ...
        } else if (isSpaceBetweenTokens(context, first, second)) {
        ...
        } else if (isSpaceBetweenTokens(context, penultimate, last)) {
