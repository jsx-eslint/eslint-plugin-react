...
const REFLECT_STATIC_MUTATORS = ['defineProperty', 'deleteProperty', 'set'];
...
module.exports = {
  meta: {
    ...
    schema: [{
      ...
      properties: {
        ...
        allowObjectStatics: {
          description: 'If true, will allow `Object` mutation methods (e.g. `Object.assign(this.props, {foo: 1})`). https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array#Mutator_methods',
          type: 'boolean',
          default: false
        },
        allowableObjectStatics: {
          description: 'Will allow a whitelist of specified `Object` static mutation methods. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array#Mutator_methods',
          type: 'array',
          default: []
        },
        allowReflectStatics: {
          description: 'If true, will allow `Reflect` mutation methods of props that are objects (e.g. `Reflect.set(this.props, "foo", 1)`).  https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Reflects/Reflect#Methods',
          type: 'boolean',
          default: false
        },
        allowableReflectStatics: {
          description: 'Will allow a whitelist of specified `Reflect` static mutation methods. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Reflect#Methods',
          type: 'array',
          default: []
        }
      },
  ...
  create: Components.detect((context, components, utils) => {
    ...
    const allowReflectStatics = options.allowReflectStatics;
    const initialReflectStatics = allowReflectStatics ? [] : REFLECT_STATIC_MUTATORS;
    const allowableReflectStatics = options.allowableReflectStatics && allowReflectStatics
      ? REFLECT_STATIC_MUTATORS.filter(mutation => options.allowableReflectStatics.indexOf(mutation) < 0)
      : initialReflectStatics;
        ...
        const isObjectMutation =
          ...
          && (
            ...
            || (
              ...
              && allowableReflectStatics.indexOf(calleeName) > -1
            )
          );
