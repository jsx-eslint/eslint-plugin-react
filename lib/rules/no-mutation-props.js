...
const OBJECT_STATIC_MUTATORS = ['Object.assign', 'Object.defineProperty', 'Object.defineProperties'];
const REFLECT_STATIC_MUTATORS = ['Reflect.defineProperty', 'Reflect.deleteProperty', 'Reflect.set'];
const LODASH_MUTATORS = ['_.fill', '_.reverse', '_.assign', '_.extend', '_.assignIn', '_.assignInWith', '_.extendWith', '_.assignWith', '_.defaults', '_.defaultsDeep', '_.merge', '_.mergeWith', '_.set', '_.setWith'];
const MUTATOR_METHODS = OBJECT_STATIC_MUTATORS.concat(REFLECT_STATIC_MUTATORS).concat(LODASH_MUTATORS);
...
module.exports = {
  meta: {
    ...
    schema: [{
      ...
      properties: {
        ...
        disabledMethods: {
          description: 'You can override this with your own set of object/method pairs.',
          type: 'array',
          default: MUTATOR_METHODS
        }
      },
  ...
  create: Components.detect((context, components, utils) => {
    ...
    const disabledMethods = Array.isArray(options.disabledMethods)
      ? options.disabledMethods
      : MUTATOR_METHODS;
    const disabledMethodMap = disabledMethods.reduce((methods, pairString) => {
      const pairs = pairString.split('.');
      const object = pairs[0];
      const method = pairs[1];
      if (!methods[object]) {
        methods[object] = [];
      }
      methods[object].push(method);
      return methods;
    }, {});
    ...
    return {
      ...
      CallExpression: function(node) {
        ...
        const isObjectMutation =
          ...
          && (
            (
              disabledMethodMap[callee.object.name]
              && disabledMethodMap[callee.object.name].indexOf(calleeName) > -1
            )
          );
